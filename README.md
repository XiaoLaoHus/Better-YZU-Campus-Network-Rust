...
> 界面采用 Apple 风格的留白、浅色卡片与圆角按钮，但编辑框、下拉框和交互均为 Windows 原生控件。图标采用绿色渐变背景、白色扬州大学校徽与 Wi-Fi 标识，用于 exe、窗口及托盘；校徽取自[学校官网提供的图片](https://www.yzu.edu.cn/__local/1/9C/B7/D2DA849218454F5605A81A3A442_5795DDB8_117BF.jpg?e=.jpg)。**本项目是第三方客户端，不代表学校官方应用或获得学校背书**。图标已嵌入 exe，无需额外资源文件。
